import { FameFabricFactory, ResourceFactory } from "../naylence/fame/core/fame-fabric-factory";
  ...
  describe("abstract class implementation", () => {
    ...
    describe("class properties", () => {
      it("implements ResourceFactory interface correctly", () => {
        const factory: ResourceFactory<FameFabric, FameFabricConfig> = testFactory;
    ...
    describe("create method with different config types", () => {
      ...
      it("passes kwargs to create method", async () => {
        const fabric = await testFactory.create(null, "arg1", 42, { key: "value" });
    ...
    describe("ResourceFactory interface compliance", () => {
      ...
      it("works with factory arrays and filtering", () => {
        ...
        const sortedFactories = [...factories].sort((a, b) => b.priority - a.priority);
