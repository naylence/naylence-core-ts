...
describe('Channel Message', () => {
  ...
  describe('FameChannelMessage Class', () => {
    describe('constructor', () => {
      ...
      it('should create channel message with envelope and context', () => {
        const channelMessage = new FameChannelMessage(
          mockEnvelope,
          mockContext
        );
  ...
  describe('extractEnvelopeAndContext', () => {
    ...
    it('should throw TypeError for invalid message type', () => {
      ...
      expect(() => extractEnvelopeAndContext(invalidMessage)).toThrow(
        TypeError
      );
      expect(() => extractEnvelopeAndContext(invalidMessage)).toThrow(
        'Unexpected message type in binding channel: string'
      );
    });
    ...
    it('should throw TypeError for null message', () => {
      ...
      expect(() => extractEnvelopeAndContext(nullMessage)).toThrow(
        'Unexpected message type in binding channel: object'
      );
    });
    ...
    it('should throw TypeError for undefined message', () => {
      ...
      expect(() => extractEnvelopeAndContext(undefinedMessage)).toThrow(
        TypeError
      );
      expect(() => extractEnvelopeAndContext(undefinedMessage)).toThrow(
        'Unexpected message type in binding channel: undefined'
      );
    });
    ...
    it('should throw TypeError for object without frame property', () => {
      ...
      expect(() => extractEnvelopeAndContext(invalidObject)).toThrow(
        'Unexpected message type in binding channel: object'
      );
    });

    it('should handle objects with frame property as FameEnvelope', () => {
      const objectWithFrame = {
